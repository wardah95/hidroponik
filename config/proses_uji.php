...
elseif ($katagoriS=="PANAS"&&$katagoriK=="LEMBAB"&&$katagoriN=="BERLEBIH")
{
	...
	$insert			= "INSERT INTO hasil_fuzzy (suhu,kelembaban,nutrisi,das,ktgs,dak,ktgk,dan,ktgn,rmss,rmsk,rmsn,hitungs,hitungk,hitungn,rekomendasi,hasil) VALUES ('$nSuhu','$nilai','$nNutris1','$DAS','$katagoriS','$DAK','$katagoriK','$DAN','$katagoriN','$rmsuhu','$rmslem','$rmsnut','$hitungs','$hitungk','$hitungn','$rekomendasi','$kondisi')";
	// die(var_dump($rekomendasi));
